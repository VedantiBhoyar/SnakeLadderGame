...
public class SnakeLadderGame {
	...
	public static String startGame(String start) throws IOException {
		...
		int compPosition = 1; // sets the default loaction for computer's piece
								// to 1
	...
	public static int getP(int userPosition, int userRoll,
	...
	public static int compgetP(int compPosition, int compRoll,
